...
describe("System One（Jev）を使う判定器", () => {
  ...
  // Bedrock 側の前置きと同じ土台で判じさせる（docs「構造化した質問定義」）
  it("問いと前置きを instructions の別の欄に分け、水準は段の順に並べる", async () => {
